...
defmodule WxWidgets.Generated.WxImage do
  defmacro __using__(_params) do
    quote do
      ...
      # @spec convertToGreyscale(this :: t(), options :: [option]) :: t() when option: {:lr, number()} | {:lg, number()} | {:lb, number()}
      ...
      # @spec findFirstUnusedColour(this :: t(), options :: [option]) :: result when option: {:startR, integer()} | {:startG, integer()} | {:startB, integer()}, result: {res :: boolean(), r :: integer(), g :: integer(), b :: integer()}
      ...
      # @spec loadFile(this :: t(), name :: :unicode.chardata(), options :: [option]) :: boolean() when option: {:type, integer()} | {:index, integer()}
      ...
      # @spec resize(this :: t(), size :: {w :: integer(), h :: integer()}, pos :: {x :: integer(), y :: integer()}, options :: [option]) :: t() when option: {:r, integer()} | {:g, integer()} | {:b, integer()}
      ...
      # @spec rotate(this :: t(), angle :: number(), centre_of_rotation :: {x :: integer(), y :: integer()}, options :: [option]) :: t() when option: {:interpolating, boolean()} | {:offset_after_rotation, {x :: integer(), y :: integer()}}
      ...
      # @spec size(this :: t(), size :: {w :: integer(), h :: integer()}, pos :: {x :: integer(), y :: integer()}, options :: [option]) :: t() when option: {:r, integer()} | {:g, integer()} | {:b, integer()}
